...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontWeight: "700", marginLeft: 20, marginVertical: 10 },
  campCard: { backgroundColor: "#E0E0E0", padding: 12, marginHorizontal: 20, borderRadius: 10, marginBottom: 10 },
  campNome: { fontSize: 16, fontWeight: "700", marginBottom: 5 },
});
